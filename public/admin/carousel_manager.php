    ...
    <div class="dash-wrapper">
        ...
        <?php if ($premiumImage): ?>
            <div class="form-card">
                ...
                <img src="../public/images/uploads/<?= htmlspecialchars($premiumImage) ?>" alt="Premium Goggles" style="width:100%;max-width:500px;border-radius:6px;">
            </div>
        <?php endif; ?>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <?php foreach ($carouselImages as $img): ?>
                            <tr>
                                <td>
                                    <img src="../public/images/uploads/<?= htmlspecialchars($img['image_path']) ?>" alt="Carousel Image" style="height:60px;border-radius:4px;">
                                </td>
